      ...
      <tr>
        ...
        <td>
          <ul class="rt-admin-tools">
            <li><?php echo rt_ui_button('revert', 'rtShopProductAdmin/Revert?id='.$rt_shop_product->getId().'&revert_to='.$version_1, 'arrowrefresh-1-e'); ?></li>
          </ul>
        <td>
          <ul class="rt-admin-tools">
            <li><?php echo rt_ui_button('revert', 'rtShopProductAdmin/Revert?id='.$rt_shop_product->getId().'&revert_to='.$version_2, 'arrowrefresh-1-e'); ?></li>
          </ul>
        </td>
      </tr>
  </tbody>
