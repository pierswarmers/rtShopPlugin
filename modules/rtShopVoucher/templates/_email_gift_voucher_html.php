...
<p><?php echo sprintf('You have received a %s gift voucher from %s %s.',format_currency($rt_shop_voucher->getReductionValue(), sfConfig::get('app_rt_currency', 'USD')),$sender_fname,$sender_lname) ?></p>
...
<p><?php echo __('Simply enter the voucher code') ?> (<code><?php echo $rt_shop_voucher->getCode() ?></code>) <?php echo __('in the payment step of ordering, to use your') ?> <?php echo format_currency($rt_shop_voucher->getReductionValue(), sfConfig::get('app_rt_currency', 'USD')) ?> <?php echo __('gift voucher') ?>.</p>